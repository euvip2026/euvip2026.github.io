...
export const speakers: Speaker[] = [
  ...
  },
  {
    ...
    bio: 'Fatma Güney is an assistant Professor at the Departement of Computer Engineering at Koç University in Istanbul. Previously, she was a postdoctoral researcher in the Visual Geometry Group (VGG) at the University of Oxford, working with Andrea Vedaldi and Andrew Zisserman. She completed her Ph.D. at the Max Planck Institute for Intelligent Systems, under the supervision of Andreas Geiger. Her research focuses on computer vision for autonomous driving. In recent years, She has published work on topics such as 3D Gaussian Splatting, point tracking, and end-to-end learning of autonomous driving. She leads a small research group with amazing students. They work on a broad range of topics at the intersection of computer vision and autonomous driving. The group welcomes applications from enthusiastic students. Those interested can check the available open positions.',
    },
