            ...
            <div className="border-muted/60 bg-primary border p-6 text-white shadow-sm inset-shadow-sm">
              <ul className="space-y-4">
                ...
                <li className="text-lg">
                  ...
                  <strong>
                    <u>
                      <a href="https://sntevents.uni.lu/product/euvip-2026-registration/">
                ...
                {/* July 23 */}
                <li className="text-lg">
                  <strong className="text-xl">July 23:</strong> Paper decisions have been released and communicated to
                  all authors!
                </li>
                {/* Incode */}
                  ...
                  <div className="flex flex-col items-start gap-5 sm:flex-row">
                    ...
                    <div className="flex min-w-0 flex-1 gap-3 text-lg">
                      ...
                      <div className="min-w-0 flex-1">
                        <p>
                          <strong className="text-xl">July 20:</strong> Sponsorship Announcement — We are pleased to
                          welcome{' '}
                          <a
                            href="https://www.incode.com"
                            target="_blank"
                        ...
                        <div className="mt-4 border-l-4 border-white/50 pl-4">
                          ...
                          <p className="mt-2 w-full leading-relaxed text-white/90">
                            ...
                            enterprises. Its end-to-end identity orchestration platform enables automated verification,
                            authentication, and fraud prevention across digital and in-person interactions while meeting
                            rigorous security and compliance standards. By advancing biometric innovation for
                ...
                <li className="flex gap-3 text-lg">
                  <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-white" aria-hidden="true" />

                  <div>
                    <strong className="text-xl">July 18:</strong> Regular paper and demo acceptance notifications
                    rescheduled to July 23, 2026, at 23:59 AoE.
                  </div>
                </li>
                ...
                <li className="rounded-xl border border-white/20 bg-white/5 p-5 shadow-sm">
                  <div className="flex flex-col items-start gap-5 sm:flex-row">
                    ...
                    <div className="flex min-w-0 flex-1 gap-3 text-lg">
                      ...
                      <div className="min-w-0 flex-1">
                        <p>
                          <strong className="text-xl">July 17:</strong> Sponsorship Announcement — We are pleased to
                          welcome{' '}
                          <a
                            href="https://thedots.lu"
                            target="_blank"
                        ...
                        <div className="mt-4 border-l-4 border-white/50 pl-4">
                          ...
                          <p className="mt-2 w-full leading-relaxed text-white/90">
                            ...
                            Combining strategic communication, branding, content and media production, community
                ...
                {/* June 30 */}
                <li className="text-lg">
                  <strong className="text-xl">June 30:</strong> All special sessions and the student session submission
                  deadlines extended to 7 July 2026, 23:59 AoE.
                </li>

                {/* June 5 */}
                <li className="text-lg">
                  <strong className="text-xl">June 5:</strong> Paper submission deadline extended to 15 June 2026, 23:59
                  AoE.
                </li>

                {/* May 28 */}
                <li className="text-lg">
                  <strong className="text-xl">May 28:</strong> Tutorial submission deadline extended to 9 June 2026,
                  23:59 AoE.
                </li>

                {/* May 20 */}
                <li className="text-lg">
                  <strong className="text-xl">May 20:</strong> Paper submission deadline extended to 5 June 2026, 23:59
                  AoE.
                </li>

                {/* May 19 */}
                <li className="text-lg">
                  <strong className="text-xl">May 19:</strong> Community and Society Announcement — supported by{' '}
                  <strong>IEEE Signal Processing Society</strong>
                </li>

                {/* May 4 */}
                <li className="text-lg">
                  <strong className="text-xl">May 04:</strong> Community and Society Announcement — supported by{' '}
                ...
                <li className="rounded-xl border border-white/20 bg-white/5 p-5 shadow-sm">
                  <div className="flex flex-col items-start gap-5 sm:flex-row">
                    ...
                    <div className="flex min-w-0 flex-1 gap-3 text-lg">
                      ...
                      <div className="min-w-0 flex-1">
                        <p>
                          <strong className="text-xl">Apr 30:</strong> Sponsorship Announcement — We are pleased to
                          welcome{' '}
                          <a
                            href="https://about.google/"
                            target="_blank"
                        ...
                        <div className="mt-4 border-l-4 border-white/50 pl-4">
                          ...
                          <p className="mt-2 w-full leading-relaxed text-white/90">
                            ...
                            businesses. Google’s portfolio includes Search, YouTube, Maps, Gmail, Chrome, Android,
                            Google Workspace, Google Cloud, Pixel devices, and advertising solutions. The company also
                            advances artificial intelligence through Google DeepMind, Google Research, and AI-powered
                            features integrated across its services. Guided by a focus on users, Google develops
                            accessible, secure, and helpful technologies for individuals, businesses, developers,
                            institutions, and communities worldwide. Its advertising business funds many widely
                            available products, while subscriptions, devices, applications, and enterprise services
                            provide additional revenue. Google further supports digital skills, sustainability,
                ...
                {/* March 20 */}
                <li className="text-lg">
                  <strong className="text-xl">Mar 20:</strong> Community and Society Announcement — supported by{' '}
                  <strong>IEEE Benelux</strong>
                </li>

                {/* March 6 */}
                <li className="text-lg">
                  <strong className="text-xl">Mar 06:</strong> Community and Society Announcement — supported by{' '}
                ...
                <li className="rounded-xl border border-white/20 bg-white/5 p-5 shadow-sm">
                  <div className="flex flex-col items-start gap-5 sm:flex-row">
                    ...
                    <div className="flex min-w-0 flex-1 gap-3 text-lg">
                      ...
                      <div className="min-w-0 flex-1">
                        <p>
                          <strong className="text-xl">Feb 26:</strong> Sponsorship Announcement — We are thrilled to
                          welcome{' '}
                          <a
                            href="https://luxembourg-convention-bureau.lu/en"
                            target="_blank"
                        ...
                        <div className="mt-4 border-l-4 border-white/50 pl-4">
                          ...
                          <p className="mt-2 w-full leading-relaxed text-white/90">
                            ...
                            meetings, conferences, congresses, and corporate gatherings. Through expert advice, venue
