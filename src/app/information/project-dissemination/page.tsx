...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/information/project-dissemination/' },
}

export default function ProjectDissemination() {
  return (
    <>
      <section className="mx-auto max-w-7xl md:px-4">
        <div className="relative h-56 overflow-hidden shadow-sm sm:h-[208px]">
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 md:p-8">
            <h2 className="text-3xl font-extrabold tracking-tight text-white md:text-4xl">Project Dissemination</h2>
